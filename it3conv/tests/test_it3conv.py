...
class TestIT3(TestCase):
    ...
    def test_tel_map(self):
        lang="tel"
        telmap={'a':'అ', 'aa':'ఆ', 'i':'ఇ', 'ii':'ఈ', 'u':'ఉ', 'uu':'ఊ', 'rx':'ఋ', 'lx':'ఌ', 'e':'ఎ',
                     'ei':'ఏ', 'ai':'ఐ', 'o':'ఒ', 'oo':'ఓ', 'au':'ఔ', 'ka':'క', 'kha':'ఖ', 'ga':'గ', 'gha':'ఘ',
                     'ng~a':'ఙ', 'cha':'చ', 'chha':'ఛ', 'ja':'జ', 'jha':'ఝ', 'nj~a':'ఞ', 't:a':'ట', 't:ha':'ఠ',
                     'd:a':'డ', 'd:ha':'ఢ', 'nd~a':'ణ', 'ta':'త', 'tha':'థ', 'da':'ద', 'dha':'ధ', 'na':'న',
                     'pa':'ప', 'pha':'ఫ', 'ba':'బ', 'bha':'భ', 'ma':'మ', 'ya':'య', 'ra':'ర', 'r:a':'ఱ',
                     'la':'ల', 'l:a':'ళ', 'va':'వ', 'sha':'శ', 'shha':'ష', 'sa':'స', 'ha':'హ', 'kaa':'కా',
                     'ki':'కి', 'kii':'కీ', 'ku':'కు', 'kuu':'కూ', 'krx':'కృ', 'krxx':'కౄ', 'ke':'కె', 'kei':'కే',
                     'kai':'కై', 'ko':'కొ', 'koo':'కో', 'kau':'కౌ', 'k':'క్', 'kn:':'కం', 'kh:':'కః', '.':'.',
