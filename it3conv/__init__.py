...
def main():
    ...
    # help messages
    src_enc_help = "{utf, it3} select input-file encoding"
    ...
    if args.norm and args.src_enc == 'it3':
        sys.stderr.write(
    ...
    if args.src_enc == "utf":  # and args.trg_enc=="it3":
        src_trg = "utf2it3"
    else:  # args.src_enc=="it3" and args.trg_enc=="utf":
        src_trg = "it32utf"
